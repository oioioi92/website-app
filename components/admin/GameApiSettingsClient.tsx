...
export function GameApiSettingsClient() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="admin-card p-6 space-y-4">
        <h2 className="text-sm font-semibold text-[var(--compact-text)] border-b border-[var(--compact-card-border)] pb-2">游戏供应商 API</h2>
