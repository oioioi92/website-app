            ...
            <tbody>
              {items.map((r) => (
                <tr key={r.id} className="border-b border-slate-100">
                  ...
                  <td className="px-4 py-3 font-mono text-[15px] font-medium text-slate-900">{r.txId}</td>
                  ...
                  <td className="px-4 py-3 text-[15px] font-medium text-slate-900">{r.channel}</td>
