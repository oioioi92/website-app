...
export const REPORT_CATALOG: ReportCategory[] = [
  ...
  },
  {
    ...
    title: "Game",
    cards: [
      { key: "winloss-game", title: "Win/Loss by Game", subtitle: "按游戏输赢", href: "/admin/reports/winloss-by-game", keywords: ["winloss","ggr","game","输赢"] },
      { key: "turnover-game", title: "Turnover by Game", subtitle: "按游戏流水", href: "/admin/reports/turnover-by-game", keywords: ["turnover","流水"] },
    ],
  },
  {
    key: "bonus",
