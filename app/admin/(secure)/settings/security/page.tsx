...
export default function SettingsSecurityPage() {
  ...
  return (
    <div className="max-w-2xl">
      ...
      <h1 className="mt-4 text-lg font-semibold text-slate-800">Security</h1>
      <p className="mt-1 text-sm text-slate-500">2FA、登录历史、安全日志等</p>
      ...
      <p className="mt-4 text-sm text-slate-500">
        修改密码请前往 <Link href="/admin/settings/password" className="text-indigo-600 hover:underline">Password</Link>。
      </p>
    </div>
  );
}
