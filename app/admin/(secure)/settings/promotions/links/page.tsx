...
/** Links 入口：有 promotionId 时跳转到该活动的编辑页，否则提示在列表行内操作 */
export default function PromotionLinksPage() {
  ...
  return (
    <div className="max-w-xl space-y-3 p-4">
      <h1 className="text-lg font-semibold text-[var(--admin-text)]">Links</h1>
      <p className="text-sm text-[var(--admin-muted)]">
        请在 <Link href="/admin/settings/promotions/list" className="text-[var(--admin-primary)] underline">Promotion List</Link> 中点击某一活动的「Links」或「编辑」进入该活动的链接与内容编辑。
      </p>
