...
export default function SettingsReferralSharingPage() {
  const { t } = useLocale();
  return (
    <div>
      ...
      <h1 className="mt-2 text-lg font-semibold text-[var(--compact-text)]">Referral — Sharing</h1>
      <p className="mt-0.5 text-[13px] text-[var(--compact-muted)]">推荐链接分享渠道与展示</p>
      <div className="mt-6">
